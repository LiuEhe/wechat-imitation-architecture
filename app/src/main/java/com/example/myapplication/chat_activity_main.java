...
public class chat_activity_main extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment_select(0);
        //将第一个图标设为选中状态
        imageView_chat.setImageResource(R.drawable.chat3);
    }
    ...
    public void onClick(View view) {
        ...
        switch(view.getId())
        {
            ...
            case R.id.contacts:
                Fragment_select(1);
                restartButton();
                imageView_contacts.setImageResource(R.drawable.contracts3);
                break;
            case R.id.circle_friend:
                Fragment_select(2);
                restartButton();
                imageView_circleoffriend.setImageResource(R.drawable.circleoffriend3);
                break;
            case R.id.settings:
                Fragment_select(3);
                restartButton();
                imageView_setting.setImageResource(R.drawable.setting3);
                break;
            default:
                break;
        }
    ...
    private void restartButton() {
        //设置为未点击状态
        imageView_chat.setImageResource(R.drawable.chat4);
        imageView_contacts.setImageResource(R.drawable.contracts4);
        imageView_circleoffriend.setImageResource(R.drawable.circleoffriend4);
        imageView_setting.setImageResource(R.drawable.setting4);
    }
